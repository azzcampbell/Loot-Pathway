...
3. Confirm the GitHub and CurseForge project licences are set to **All Rights Reserved**.
4. Show the complete changelog to Aaron and wait for explicit approval.
5. Commit the approved addon and changelog changes locally.
6. Run `Publish-Release.ps1 -Version X.Y.Z -ChangelogApproved`.
7. Confirm that the GitHub release succeeds and that CurseForge receives the package.
